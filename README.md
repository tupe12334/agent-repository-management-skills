...
- `skills/autonomous-ai-agents/agent-plugin-management/` — own durable agent plugins and extensions in dedicated repositories and consume verified revisions as configuration dependencies.
